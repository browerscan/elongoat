        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm text-white/70 md:text-base">
              {articleCount.toLocaleString()} long-form articles generated from{" "}
              {tweetStats?.totalTweets.toLocaleString() || "55K+"} tweets and
              curated sources. Each article is 1,200+ words of deep analysis.
            </p>
          </div>
