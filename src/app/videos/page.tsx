...
export const metadata: Metadata = {
  title: "Videos",
  description:
    "Elon Musk related videos discovered via Google Videos (SOAX) with optional transcripts.",
};
        ...
        <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm text-white/60">
              This index is built from Google Videos search results (via SOAX).
              You can enrich entries with YouTube transcripts using the worker
              in{" "}
