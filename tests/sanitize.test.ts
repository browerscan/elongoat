...
describe("Input Sanitization", () => {
  ...
  describe("sanitizeSlug", () => {
    it("should convert to lowercase", async () => {
      const { sanitizeSlug } = await import("@/lib/sanitize");
  ...
  describe("detectSqlInjection", () => {
    it("should detect SELECT injection", async () => {
      const { detectSqlInjection } = await import("@/lib/sanitize");
  ...
  describe("detectXss", () => {
    it("should detect script tags", async () => {
      const { detectXss } = await import("@/lib/sanitize");
  ...
  describe("sanitizeNumber", () => {
    it("should return valid numbers", async () => {
      const { sanitizeNumber } = await import("@/lib/sanitize");
  ...
  describe("sanitizeIntRange", () => {
    it("should clamp to minimum", async () => {
      const { sanitizeIntRange } = await import("@/lib/sanitize");
